...
(def configs
  {:pedestal-app
   {:build {:watch-files (compile/html-files-in "templates")
            ...
            :triggers {:html [#"pedestal_app/app.js"]}}
    ...
    :control-panel {:design {:uri "/design.html"
                             :name "Design"
                             :order 0}}
    :aspects {:development {:uri "/pedestal-app-dev.html"
                            :name "Development"
                            :out-file "pedestal-app-dev.js"
                            :scripts ["goog.require('pedestal_app.app');"
                                      "pedestal_app.app.main();"]
                            :order 1}
              :production {:uri "/pedestal-app.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "pedestal-app.js"
                           :scripts ["pedestal_app.app.main();"]
                           :order 2}}}})
